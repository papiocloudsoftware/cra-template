...
interface GoogleOAuthActionProps
  extends Omit<SignInActionProps, 'stack' | 'onClose'> {
  readonly innerRef: Ref<HTMLDivElement>;
}
...
export const SignInAction = forwardRef<HTMLDivElement, SignInActionProps>(
  (props, ref) => {
