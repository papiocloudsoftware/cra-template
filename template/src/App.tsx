...
function App() {
  ...
  const modalElement =
    modalStack.length > 0 ? modalStack[modalStack.length - 1].element : <></>;

  return (
    <Paper
      sx={{ minHeight: '100vh', backgroundColor: ColorPalette.backgroundGray }}
    >
      ...
      <BrowserRouter>
        ...
        />
        <MainContent
          menuWidth={persistentMenu && state.menuVisible ? menuWidth : 0}
        />
      </BrowserRouter>
    </Paper>
  );
